        ...
        <div id="hd-contain" class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a id="user-reg" href="{{ url('user/register') }}">RERA Registration</a></li>
                    @else
                        <li class="dropdown">
                                            ...
                                            <div class="col-md-8 col-md-offset-2">
                                                    <div class="panel panel-default" id="user-form-panel">
                                                        ...
                                                        <div class="panel-body" id="inner-user-pb">
                                                            <form id="user-login-form" class="form-horizontal" role="form" method="POST" action="{{ url('/user/login') }}">
                                                                {{ csrf_field() }}
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/login') }}">
                                                                {{ csrf_field() }}
                                                                <div id="fg-al-1" class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                                                ...
                                                                <div id="fg-al-2" class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
