                                ...
                                <div class="panel with-nav-tabs panel-primary">
                                    <div class="panel-heading" id="hdg-one">
                                        <ul class="nav nav-tabs" id="click-tabs">
                                            <li role="presentation" class="active" id="hcpro-li"><a role="tab" href="#dash-home-tab" aria-controls="user profile" data-toggle="tab"><i class="fa fa-btn fa-address-card-o"></i> User Profile</a></li>
                                            <li role="presentation" id="admin-li"><a role="tab" href="#wheelchairs-tab" aria-controls="wheelchairs" data-toggle="tab"><i class="fa fa-btn fa-bank"></i> User Account</a></li>
                                        </ul>
                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading" id="wc-panel-head">
                                                                    <h5 id="wc-req-head-title">{{$user->username}}'s Current Profile</h5>
                                                                </div>
                                                                <div id="profile-content" class="form-horizontal">
                                                                    <!-- Start Of 2nd Tab User Account -->
                                                                    <a id="profile-img-link" href="#wheelchairs-tab">
                                                                    <img id="avatar-image" src="/defaults/avatars/{{$user->avatar}}" alt="{{$user->username}}"/>
                                                                    </a>
                                                                    <h2>{{$user->firstname}} {{$user->lastname}}'s Profile Account</h2>
                                                                </div>
                                                ...
                                                <div class="form-container">
                                                    <div class="row" id="form-row">
                                                        <div class="col-md-12">
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading" id="wc-panel-head">
                                                                    <h5 id="wc-req-head-title">{{$user->username}}'s User Account</h5>
                                                                </div>
