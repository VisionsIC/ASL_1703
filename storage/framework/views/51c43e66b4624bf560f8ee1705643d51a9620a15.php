...
<head>
    ...
    <title>RERA Application | Main Line Health</title>
    <!-- Bootstrap core CSS -->
                ...
                <?php else: ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(url('profile')); ?>"><i class="fa fa-btn fa-user-circle"></i> Profile</a></li>
                            <li>
...
<footer>
    <p class="company-info" align="center">2017 | Main Line Health | For now ... as a ASL course project</p>
</footer>
<!-- End Application Page Elements ->
    <!-- Application script file -->
    <script src="<?php echo e(asset('js/jquery-3.1.1.js')); ?>"></script>
    <script src="<?php echo e(asset('js/app.js')); ?>"></script>
    <script src="<?php echo e(asset('js/tabs.js')); ?>"></script>
    <script src="<?php echo e(asset('js/select_control.js')); ?>"></script>
    <script src="<?php echo e(asset('js/script.js')); ?>"></script>
    <!-- Scripts -->
    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]>
    <script src="<?php echo e(asset('js/ie8-responsive-file-warning.js')); ?>"></script>
    <![endif]-->
