                        ...
                        <div class="container">
                            <div class="row" id="wizard-row">
                                <div class="wizard">
                                    ...
                                    <form role="form" method="POST" action="<?php echo e(url('/user/wc_requests')); ?>">
                                            ...
                                            <fieldset class="tab-pane active" role="tabpanel" id="step1">
                                                ...
                                                <p id="fg-fw-1" class="form-group">
                                                    ...
                                                    <select title="unit" id="unit_id" class="units form-control select-picker show-tick" name="unit" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\Unit::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            ...
                                            <fieldset class="tab-pane" role="tabpanel" id="step2">
                                                ...
                                                <p id="fg-fw-6" class="form-group">
                                                    ...
                                                    <select title="therapist_title" id="therapist_title" class="therapist_title form-control select-picker show-tick" name="therapist_title" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\TherapistTitle::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($title->id); ?>"><?php echo e($title->title_abbreviation); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                                ...
                                                <p id="fg-fw-8" class="form-group">
                                                    ...
                                                    <select title="wc_type" id="wc_type" class="wc_types form-control select-picker show-tick" name="wc_type" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\WheelchairType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wc_type): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($wc_type->id); ?>"><?php echo e($wc_type->wc_type); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                            ...
                                            <fieldset class="tab-pane" role="tabpanel" id="step3">
                                                ...
                                                <p id="fg-fw-11" class="form-group">
                                                    ...
                                                    <select title="wc_dimensions" id="wc_dimensions" class="wc_dimensions form-control select-picker show-tick" name="wc_dimensions" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\WheelchairDimension::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wc_dems): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($wc_dems->id); ?>"><?php echo e($wc_dems->wc_dimensions); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                                ...
                                                <p id="fg-fw-12" class="form-group">
                                                    ...
                                                    <select title="wc_height" id="wc_height" class="wc_heights form-control select-picker show-tick" name="wc_height" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\WheelchairHeight::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wc_height): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($wc_height->id); ?>"><?php echo e($wc_height->wc_height); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                            ...
                                            <fieldset class="tab-pane" role="tabpanel" id="step4">
                                                ...
                                                <p id="fg-fw-13" class="form-group">
                                                    ...
                                                    <select title="wc_back" id="wc_back" class="wc_back_type form-control select-picker show-tick" name="wc_back" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\WheelchairBack::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wc_back): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($wc_back->id); ?>"><?php echo e($wc_back->wc_back_type); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                                ...
                                                <p id="fg-fw-14" class="form-group">
                                                    ...
                                                    <select title="cushion_type" id="cushion_type" class="cushion_type form-control select-picker show-tick" name="cushion_type" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\CushionType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cushion_type): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($cushion_type->id); ?>"><?php echo e($cushion_type->cushion_type); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                                ...
                                                <p id="fg-fw-15" class="form-group">
                                                    ...
                                                    <select title="cushion_dimensions" id="cushion_dimensions" class="cushion_dimensions form-control select-picker show-tick" name="cushion_dimensions" data-style="btn-info" autofocus>
                                                        <option value="0" disabled selected>Select Cushion Type</option>
                                                        <?php $__currentLoopData = App\CushionDimension::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cushion_dem): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($cushion_dem->id); ?>"><?php echo e($cushion_dem->cushion_dimensions); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
                                                ...
                                                <p id="fg-fw-16" class="form-group">
                                                    ...
                                                    <select title="armrest_type" id="armrest_type" class="armrest_type form-control select-picker show-tick" name="armrest_type" data-style="btn-info" autofocus>
                                                        ...
                                                        <?php $__currentLoopData = App\ArmrestType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $armrest_type): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                            <option value="<?php echo e($armrest_type->id); ?>"><?php echo e($armrest_type->armrest_type); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                    </select>
                                                </p>
