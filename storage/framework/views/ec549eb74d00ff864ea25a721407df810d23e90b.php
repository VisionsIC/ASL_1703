...
<head>
    ...
    <!-- Bootstrap Font Awesome 4.7 CSS -->
        ...
        <div id="hd-contain" class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(Auth::guest()): ?>
                        <li><a id="user-reg" href="<?php echo e(url('user/register')); ?>">RERA Registration</a></li>
                    <?php else: ?>
                        <li class="dropdown">
                                        ...
                                        <div class="container">
                                            <div class="col-md-8 col-md-offset-2">
                                                    <div class="panel panel-default" id="user-form-panel">
                                                        <div class="panel-heading" id="form-head">RERA HealthCare Professional Login Form</div>
                                                        <div class="panel-body" id="inner-user-pb">
                                                            <form id="user-login-form" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/user/login')); ?>">
                                                                <?php echo e(csrf_field()); ?>

                                                                <div id="fg-ul-1" class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                                                                    <label for="username" class="label-user col-md-4 control-label">Username</label>
                                                                    <div class="col-md-6">
                                                                        <input id="username" type="text" class="input-user form-control" name="username" value="<?php echo e(old('username')); ?>" autofocus>
                                                                ...
                                                                <div id="fg-ul-2" class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                                                ...
                                                                <div id="div-ul-btn">
                                                                <div id="fg-ul-3" class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div id="user-login" class="col-md-8 col-md-offset-4">
                                        ...
                                        <div class="container">
                                                <div class="col-md-8 col-md-offset-2">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">RERA Administrator Login Form</div>
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/login')); ?>">
                                                                <?php echo e(csrf_field()); ?>

                                                                <div id="fg-al-1" class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                                                                ...
                                                                <div id="fg-al-2" class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                                                ...
                                                                <div id="div-al-btn">
                                                                <div id="fg-al-3" class="form-group">
                                                                    <div class="col-md-6 col-md-offset-4">
                                                                        <div class="checkbox">
                                                                            <label>
                                                                                <input type="checkbox" name="remember"> Remember Me
